...
import net.sf.l2j.gameserver.model.itemcontainer.listeners.CostumeListener;
import net.sf.l2j.gameserver.model.itemcontainer.listeners.CostumeListener_hair;
...
public class PcInventory extends Inventory
{
	...
	public PcInventory(Player owner)
	{
		...
		addPaperdollListener(CostumeListener.getInstance());
		addPaperdollListener(CostumeListener_hair.getInstance());
	}
	...
	public void equipItem(ItemInstance item)
	{
		...
		if  (getOwner().isInStoreMode() || (!getOwner().isHero() && item.isHeroItem()))
			return;
