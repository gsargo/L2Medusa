...
public final class World
{
	...
	public static final int TILE_X_MIN = 12;//default 16
	...
	private final Map<Integer, Pet> _agats = new ConcurrentHashMap<>();
	...
	public Pet getAgat(int ownerId)
	{
		return _agats.get(ownerId);
	}
	
	public void addAgat(int ownerId, Pet pet)
	{
		_agats.putIfAbsent(ownerId, pet);
	}
	
	public void removeAgat(int ownerId)
	{
		_agats.remove(ownerId);
	}
