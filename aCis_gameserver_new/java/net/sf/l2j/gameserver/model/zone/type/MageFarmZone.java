...
public class MageFarmZone  extends ZoneType
{
	...
	protected void onEnter(Creature character)
	{
		...
		{	
			...
			SkillTable.getInstance().getInfo(9978, 1).getEffects(player,player);
