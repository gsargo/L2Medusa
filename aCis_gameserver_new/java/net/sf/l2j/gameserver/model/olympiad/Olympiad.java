...
public class Olympiad
{
	...
	public void olympiadEnd(Player player)
	{
		...
		player.sendMessage("Olympiad period ends in " + numDays + " days, " + numHours + " hours and " + numMins + " mins.");
		
	}
	
	public String olympiadEnd_toString()
	{
		...
		return "Olympiad period ends in " + numDays + " days, " + numHours + " hours and " + numMins + " mins.";
	...
	private void setNewOlympiadEnd()
	{
		...
		currentTime.add(Calendar.WEEK_OF_MONTH, 2);
		...
		currentTime.set(Calendar.SECOND, 0);
		 ...
		 {
	            currentTime.add(Calendar.WEEK_OF_MONTH, 2);
	            LOGGER.info("Olympiad: added self +1 week.");
		 }
