...
public class CreatureStatus<T extends Creature>
{
	...
	{
		return Math.min((int) calcStat(Stats.CRITICAL_RATE, _actor.getTemplate().getBaseCritRate(), target, skill), 500); // default critical 500
	}
	...
	{
		return (int) calcStat(Stats.MCRITICAL_RATE, 2, target, skill);
	}
