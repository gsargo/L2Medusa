...
/**
 * This class extends {@link Attackable} and manages all {@link PK_Guard}s.<br>
 * <br>
 * A {@link PK_Guard} is used to protect Players from Player Killers (PKs).
 */
public final class PK_Guard extends Attackable
{
	public PK_Guard(int objectId, NpcTemplate template)
	{
	...
	public boolean canAutoAttack(Creature target)
	{
		...
		if (player == null || player.isAlikeDead() || player.getKarma()<=0)
			return false;	
