...
public final class Say2 extends L2GameClientPacket
{
	...
	protected void runImpl()
	{
		...
		if (player.getPvpKills() < 25 && type == SayType.TRADE && !player.isGM())
		{
			player.sendMessage("You need at least 25 PvP in order to use this type of chat.");
			return;
		}
		
		if (player.getStatus().getLevel() < 20 && type == SayType.SHOUT && !player.isGM())
		{
			player.sendMessage("You need to reach level 20 in order to use this type of chat.");
			return;
		}
