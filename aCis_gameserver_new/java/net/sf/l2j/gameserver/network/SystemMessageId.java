...
public final class SystemMessageId
{
	...
	/**
	 * ID: 1517<br>
	 * Message: Failed in Blessed Enchant. The enchant value of the item became 3.
	 */
	...
	/**
	 * ID: 2032<br>
	 * Message: You can not attack from that position.
	 */
	public static final SystemMessageId CANNOT_ATTACK_FROM_THAT_POSITION;
	
	/**
	 * ID: 2154<br>
	 * Message: Incognito hit you for $s1 damage
	 */
	public static final SystemMessageId INCOGNITO_GAVE_YOU_S1_DMG;
	/**
	...
	static
	{
		...
		CANNOT_ATTACK_FROM_THAT_POSITION = new SystemMessageId(2032);
		INCOGNITO_GAVE_YOU_S1_DMG = new SystemMessageId(2154);
