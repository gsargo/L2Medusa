...
public abstract class AbstractNpcInfo extends L2GameServerPacket
{
	...
	public static class NpcInfo extends AbstractNpcInfo
	{
		...
		public NpcInfo(Npc npc, Player attacker)
		{
			...
			// NPC crest system
			if (Config.SHOW_NPC_CREST && _npc.getCastle() != null && _npc.getCastle().getOwnerId() != 0 && !_npc.isAgathion())
			{
	...
	public static class SummonInfo extends AbstractNpcInfo
	{
		...
		public SummonInfo(Summon summon, Player attacker, int val)
		{
			...
			// _title = (_owner == null || !_owner.isOnline()) ? "" : null;
			...
			if (_summon.isAgathion())
			{
				_name = " ";
				_title = " ";
			}
			// NPC crest system
			if (Config.SHOW_SUMMON_CREST && _owner != null && _owner.getClan() != null && !_summon.isAgathion())
			{
