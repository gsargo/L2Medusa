...
public class UserInfo extends L2GameServerPacket
{
	...
	protected final void writeImpl()
	{
		...
		if(_player.getPolymorphTemplate() != null)
			writeS(_player.getPolymorphTemplate().getName());
		else if(_player.isVIP())
		...
		writeD(_player.getTempGloves() != 0 ? _player.getTempGloves() : _inv.getItemObjectIdFrom(Paperdoll.GLOVES));
		writeD(_player.getTempChest() != 0 ? _player.getTempChest() : _inv.getItemObjectIdFrom(Paperdoll.CHEST));
		writeD(_player.getTempLegs() != 0 ? _player.getTempLegs() : _inv.getItemObjectIdFrom(Paperdoll.LEGS));
		writeD(_player.getTempFeet() != 0 ? _player.getTempFeet() : _inv.getItemObjectIdFrom(Paperdoll.FEET));
		writeD(_inv.getItemObjectIdFrom(Paperdoll.CLOAK));
		writeD(_inv.getItemObjectIdFrom(Paperdoll.RHAND));
		writeD(_player.getTempHair() != 0 ? _player.getTempHair() : _inv.getItemObjectIdFrom(Paperdoll.HAIR));
		writeD(_player.getTempFace() != 0 ? _player.getTempFace() : _inv.getItemObjectIdFrom(Paperdoll.FACE));
		
		// TODO delete
		/*
		 * if (_player.getStatus().getHp() >= (_player.getStatus().getMaxHp() * 70 / 100f)) { writeD(_player.getTempGloves() != 0 ? _player.getTempGloves() : _inv.getItemObjectIdFrom(Paperdoll.GLOVES)); writeD(_player.getTempChest() != 0 ? _player.getTempChest() :
		 * _inv.getItemObjectIdFrom(Paperdoll.CHEST)); writeD(_player.getTempLegs() != 0 ? _player.getTempLegs() : _inv.getItemObjectIdFrom(Paperdoll.LEGS)); writeD(_player.getTempFeet() != 0 ? _player.getTempFeet() : _inv.getItemObjectIdFrom(Paperdoll.FEET));
		 * writeD(_inv.getItemObjectIdFrom(Paperdoll.CLOAK)); writeD(_inv.getItemObjectIdFrom(Paperdoll.RHAND)); writeD(_player.getTempHair() != 0 ? _player.getTempHair() : _inv.getItemObjectIdFrom(Paperdoll.HAIR)); writeD(_player.getTempFace() != 0 ? _player.getTempFace() :
		 * _inv.getItemObjectIdFrom(Paperdoll.FACE)); } else { writeD(_inv.getItemObjectIdFrom(Paperdoll.GLOVES)); writeD(_inv.getItemObjectIdFrom(Paperdoll.CHEST)); writeD(_inv.getItemObjectIdFrom(Paperdoll.LEGS)); writeD(_inv.getItemObjectIdFrom(Paperdoll.FEET));
		 * writeD(_inv.getItemObjectIdFrom(Paperdoll.CLOAK)); writeD(_inv.getItemObjectIdFrom(Paperdoll.RHAND)); writeD(_inv.getItemObjectIdFrom(Paperdoll.HAIR)); writeD(_inv.getItemObjectIdFrom(Paperdoll.FACE)); }
		 */
