...
import net.sf.l2j.gameserver.mods.antibot.AntibotProtection;
...
import c1c0s.AutoReward.GameTopsEU;
import c1c0s.AutoReward.Hopzone;
import c1c0s.AutoReward.L2Net;
import c1c0s.AutoReward.L2Servers;
import c1c0s.AutoReward.L2TopEu;
import c1c0s.AutoReward.L2Topgr;
import c1c0s.AutoReward.L2Topservers;
import c1c0s.AutoReward.L2Votes;
import c1c0s.AutoReward.L2jbrasil;
import c1c0s.AutoReward.L2jtop;
import c1c0s.AutoReward.L2topco;
import c1c0s.AutoReward.L2topgsnet;
import c1c0s.AutoReward.Mmotopeu;
import c1c0s.AutoReward.Mmotopru;
import c1c0s.AutoReward.Network;
import c1c0s.AutoReward.ServerTop;
...
public class GameServer
{
	...
	public GameServer() throws Exception
	{
		...
		StringUtil.printSection("Icon Data");
		IconsData.getInstance();
		...
		CancelBuffRestoreTaskManager.getInstance().start();
		...
		StringUtil.printSection("Auto Vote Reward System");
		if (Config.ENABLE_VOTE_SYSTEM)
		{
			Hopzone.getInstance();
			Network.getInstance();
			Topzone.getInstance();
			TopzoneAPI.getInstance();
			Mmotopeu.getInstance();
			L2Topservers.getInstance();
			L2topgsnet.getInstance();
			L2topco.getInstance();
			L2jbrasil.getInstance();
			L2Votes.getInstance();
			itopz.getInstance();
			Mmotopru.getInstance();
			L2Servers.getInstance();
			L2jtop.getInstance();
			L2Topgr.getInstance();
			GameTopsEU.getInstance();
			ServerTop.getInstance();
			L2Net.getInstance();
			L2TopEu.getInstance();
