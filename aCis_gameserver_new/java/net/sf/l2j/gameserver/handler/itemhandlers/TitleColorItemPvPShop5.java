...
public class TitleColorItemPvPShop5 implements IItemHandler
{
	...
	public void useItem(Playable playable, ItemInstance item, boolean forceUse)
	{
		...
		{
			/*Blue */
			activeChar.getMemos().set("title_color", Integer.decode("0xbf6336"));
			activeChar.getAppearance().setTitleColor(Integer.decode("0xbf6336"));
