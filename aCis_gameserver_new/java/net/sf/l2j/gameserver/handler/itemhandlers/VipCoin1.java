 ...
 * @author Anarchy
 */
public class VipCoin1 implements IItemHandler
{
	@Override
	public void useItem(Playable playable, ItemInstance item, boolean forceUse)
	{
		...
		{
			player.setVIP(true);
			player.setVIPUntil(System.currentTimeMillis() + (1000 * 60 * 60 * 24));
			player.store();
			player.sendMessage("You are now a premium member for 24 hours.");
