 ...
 * @author Anarchy
 */
public class VipCoin4 implements IItemHandler
{
	@Override
	public void useItem(Playable playable, ItemInstance item, boolean forceUse)
	{
		...
		{
			player.setVIP(true);
			player.setVIPUntil(System.currentTimeMillis() + (1000 * 60 * 60 * 24 * 7));
			player.store();
			player.sendMessage("You are now a premium member for 7 days.");
