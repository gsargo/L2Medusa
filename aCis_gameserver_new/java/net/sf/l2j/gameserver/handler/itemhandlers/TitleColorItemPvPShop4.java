...
public class TitleColorItemPvPShop4 implements IItemHandler
{
	...
	public void useItem(Playable playable, ItemInstance item, boolean forceUse)
	{
		...
		{
			/* Light Brown */
			activeChar.getMemos().set("title_color", Integer.decode("0x6BB2F6"));
			activeChar.getAppearance().setTitleColor(Integer.decode("0x6BB2F6"));
