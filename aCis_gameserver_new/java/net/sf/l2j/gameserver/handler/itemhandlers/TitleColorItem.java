...
public class TitleColorItem implements IItemHandler
{
	...
	public void useItem(Playable playable, ItemInstance item, boolean forceUse)
	{
		...
		{
		/*Dark Red */	
		activeChar.getMemos().set("title_color",Integer.decode("0x000099"));
		activeChar.getAppearance().setTitleColor(Integer.decode("0x000099"));
