...
public class TitleColorItem2 implements IItemHandler
{
	...
	public void useItem(Playable playable, ItemInstance item, boolean forceUse)
	{
		...
		{
			/*Purple*/
			activeChar.getMemos().set("title_color", Integer.decode("0xA300A3"));
			activeChar.getAppearance().setTitleColor(Integer.decode("0xA300A3"));
