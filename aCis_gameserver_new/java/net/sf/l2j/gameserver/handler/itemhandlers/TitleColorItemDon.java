...
public class TitleColorItemDon implements IItemHandler
{
	...
	public void useItem(Playable playable, ItemInstance item, boolean forceUse)
	{
		...
		{	
			/* Cyan */
			activeChar.getMemos().set("title_color",Integer.decode("0xFFFF00"));
			activeChar.getAppearance().setTitleColor(Integer.decode("0xFFFF00"));
