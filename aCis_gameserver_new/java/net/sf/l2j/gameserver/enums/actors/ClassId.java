...
public enum ClassId
{
	...
	private static final ClassId[] SUMMONERS =
	{
		ClassId.ARCANA_LORD,
		ClassId.WARLOCK,
	...
	private static final ClassId[] LIGHT_CLASS_ITEM_USE =
	{
		ClassId.SAGGITARIUS,
		ClassId.HAWKEYE,
		ClassId.GHOST_SENTINEL,
	...
	public static final ClassId[] HEAVY_CLASS_ITEM_USE =
	{
		ClassId.GLADIATOR,
		ClassId.DUELIST,
		ClassId.HELL_KNIGHT,
	...
	{
		return ArraysUtil.contains(LIGHT_CLASS_ITEM_USE, this);
	}
	
	public boolean CanUseHeavy()
	{
		return ArraysUtil.contains(HEAVY_CLASS_ITEM_USE, this);
	}
	
	public boolean isSummoner()
	{
		return ArraysUtil.contains(SUMMONERS, this);
	}
