...
public class TopzoneAPI
{
	public static Logger _log = Logger.getLogger(TopzoneAPI.class.getName());
	...
	private TopzoneAPI()
	{
		_log.info("Auto Reward Manager: TOPZONE-API Loaded Successfully");
		if (topzone)
		{
	...
	public static int gettopzoneVotes()
	{
		...
		try
		{
			final URL obj = new URL(Config.VOTES_SITE_TOPZONE_URL_API);
		...
		{
			e.printStackTrace();
			System.out.println("Error while getting TOPZONE-API vote count.");
		}
	...
	public static TopzoneAPI getInstance()
	{
		if (Config.VOTES_SITE_TOPZONE_URL_API != null && !Config.VOTES_SITE_TOPZONE_URL_API.equals(""))
		{
			topzone = true;
		}
	...
	{
		protected static final TopzoneAPI _instance = new TopzoneAPI();
	}
