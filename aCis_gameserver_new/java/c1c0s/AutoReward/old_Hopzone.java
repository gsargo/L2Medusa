...
public class old_Hopzone
{
	public static Logger _log = Logger.getLogger(old_Hopzone.class.getName());
	...
	public static old_Hopzone getInstance()
	{
	...
	{
		protected static final old_Hopzone _instance = new old_Hopzone();
	}
