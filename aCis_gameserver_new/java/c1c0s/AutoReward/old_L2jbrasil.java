...
public class old_L2jbrasil
{
	public static Logger _log = Logger.getLogger(old_L2jbrasil.class.getName());
	...
	public static old_L2jbrasil getInstance()
	{
	...
	{
		protected static final old_L2jbrasil _instance = new old_L2jbrasil();
	}
